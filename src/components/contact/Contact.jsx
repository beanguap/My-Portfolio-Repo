            ...
            <div className='contact__content'>
                ...
                <div className='contact__info'>
                    <div className='contact__card'>
                        ...
                        <span className='contact__card-data'>martinez.jeriel01@gmail.com</span>
                ...
                <div className='contact__info'>
                    <div className='contact__card'>
                        ...
                        <span className='contact__card-data'>Beanguap</span>

                        <a href='Beanguap' className='contact__button'>
                            Write me{" "}
                            <i className='bx bx-right-arrow-alt contact__button-icon'></i>
                        </a>
                    </div>
